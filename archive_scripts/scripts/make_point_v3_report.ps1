...
$PinnedRunDir = "outputs\grape_point_v3_main"
...
$command = @(
    ...
    "tools\\make_grape_point_v3_report.py",
...
Write-Host "[point_v3 report] organized run dir: $resolvedRunDir"
