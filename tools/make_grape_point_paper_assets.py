...
from make_grape_point_report import (
...
DEFAULT_EXP2_SUMMARY = REPO_ROOT / "outputs" / "grape_point_gppoint_detr_main" / "report" / "summary.json"
DEFAULT_EXP2_REPRO_SUMMARY = REPO_ROOT / "outputs" / "grape_point_gppoint_detr_main_repro1" / "report" / "summary.json"
DEFAULT_OUT_DIR = REPO_ROOT / "outputs" / "grape_point_v7_paper_ready"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate paper-ready assets for baseline / v7_exp1 / GPPoint-DETR.")
