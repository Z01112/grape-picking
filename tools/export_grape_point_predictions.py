...
DEFAULT_CHECKPOINT = REPO_ROOT / "outputs" / "grape_point_gppoint_detr_main" / "best_composite.pth"
DEFAULT_DATASET_ROOT = REPO_ROOT / "dataset"
DEFAULT_OUTPUT = REPO_ROOT / "outputs" / "grape_point_gppoint_detr_main" / "predictions" / "test_predictions.json"
