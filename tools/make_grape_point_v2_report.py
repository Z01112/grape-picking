...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "rtv4" / "rtv4_hgnetv2_s_grape_point_v2.yml"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a full report for grape point runs.")
    ...
    parser.add_argument("--reference-label", default="point_v2")
    parser.add_argument("--report-title", default="point 实验中文结论")
