...
$PinnedReportDir = "outputs\grape_point_v5_baseline_replay\report"
...
$command = @(
    ...
    "--report-title", "point_v5 baseline replay 中文结论",
    "--report-mode", "point_v5_baseline_replay",
...
if ($LASTEXITCODE -ne 0) {
    throw "[point_v5 baseline_replay] report generation failed with exit code $LASTEXITCODE"
}
